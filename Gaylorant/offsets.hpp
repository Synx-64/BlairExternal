...
namespace VALROM {
    namespace offsets
    {
        ...
        constexpr uintptr_t control_rotation = 0x124C; // local_player_controller + control_rotation // TYPE=Vector3
        ...
        constexpr uintptr_t camera_cache = 0x1FE0; // camera_manager + camera_cache // TYPE=Vector3
        ...
        constexpr uintptr_t last_submit_time = 0x364 + 0x4; // mesh_component + last_render_time // TYPE=float
        constexpr uintptr_t last_render_time = last_submit_time + 0x4; // mesh_component + last_submit_time // TYPE=float
